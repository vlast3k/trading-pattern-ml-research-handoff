...
- Workflow/config errors that prevent the local worker from creating branches/PRs and getting automated review.
...
If cheap and relevant, inspect changed Python files and suggest commands such as:

```bash
python -m py_compile <changed_file.py>
```

Do not run heavy backtests or data-generation jobs.
